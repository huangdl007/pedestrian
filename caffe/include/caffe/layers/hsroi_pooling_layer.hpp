#ifndef CAFFE_HSROI_POOLING_LAYER_HPP_
#define CAFFE_HSROI_POOLING_LAYER_HPP_
...
/** 
 * @brief Perform head&shoulders-sensitive average pooling on regions of interest specified by input, takes
 ...
 *   [N x (CxK) x H x W] feature maps on which pooling is performed. bottom[1] is
 ...
 *
 * 
 * Written by Huang Deliang
 */

template <typename Dtype>
class HSROIPoolingLayer : public Layer<Dtype> {
 public:
  explicit HSROIPoolingLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "HSROIPooling"; }
...
#endif  // CAFFE_HSROI_POOLING_LAYER_HPP_
